...
public class PlatformThreadScalingDemo {
    private static final int THREAD_COUNT = 10_000;

    public static void main(String[] args) throws Exception {
        System.out.println("Creating " + THREAD_COUNT + " platform threads...");
        ...
        System.out.println("Platform thread execution time: " + (endRun - startRun) + " ms");
    }
